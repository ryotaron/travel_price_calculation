...
def user_select_plan(travel_plans)
  while true do
...
def disp_selected_plan(travel_plans,plan_number)
  ...
  selected_travel_plan
end

def user_select_person_num
  while true do
  puts "参加人数を入力してください！"
...
plan_number = user_select_plan(travel_plans)
selected_travel_plan = disp_selected_plan(travel_plans,plan_number)
person_number = user_select_person_num
